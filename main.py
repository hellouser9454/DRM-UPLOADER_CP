...
credit ="😎𝖘:)™~" 
OWNER = int(os.environ.get("OWNER", 8272089956))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "8272089956").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="8441076045:AAGVbACGimezYeghMZXZCr6h_mEOOBHEsJc",    
   api_id=38504611 ,    
   api_hash= "420384645adef5188488fba99dd61df6"
)
